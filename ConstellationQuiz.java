...
public class ConstellationQuiz extends Contents {
   ...
   /**
      ...
      public ConstellationQuiz() {
         ...
         JLabel lblWhichTwoMoons = new JLabel("What is a group of stars in the sky that form an imaginary picture?");
         lblWhichTwoMoons.setForeground(Color.WHITE);
         lblWhichTwoMoons.setBounds(108, 130, 536, 37);
         contentPane.add(lblWhichTwoMoons);

         JRadioButton rdbtnNewRadioButton = new JRadioButton("Galaxy");
         ...
         JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Constellation");
         rdbtnNewRadioButton_1.setForeground(Color.WHITE);
         rdbtnNewRadioButton_1.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent arg0) {
               JOptionPane.showMessageDialog(null, "Correct! The answer is a constellation!",
                     "Quiz", JOptionPane.INFORMATION_MESSAGE);
         ...
         JRadioButton rdbtnNewRadioButton_2 = new JRadioButton("Moon");
